...
export const createMarket = async (
  ...
  try {
    ...
    console.log(
      "Trnasactions for market creation is ready, sending transactions"
    );
    try {
      ...
      while (true) {
        if (index1 > 10) {
          ...
          if (!sig1) console.log("Retrying create vault transaction");
            ...
            console.log(
              `Vault signature: https://solscan.io/tx/${sig1}${
      ...
      while (true) {
        if (index2 > 10) {
          ...
          if (!sig2) console.log("Retrying create market transaction");
            ...
            console.log(
              `Market signature: https://solscan.io/tx/${sig2}${
                cluster == "devnet" ? "?cluster=devnet" : ""
              }`
            );
            break;
      ...
      console.log(
        "Market ID: ",
        `https://solscan.io/account/${marketAccounts.market.publicKey.toBase58()}${
          cluster == "devnet" ? "?cluster=devnet" : ""
        }`
      );
